...
class WelcomeToArgon(ct.CTk):
    def __init__(self):
        ...
        self.microsft_btn = ct.CTkButton(self.main_frame, text="Login with Microsoft", image=micro_img, font=("Inter", 15),  command=lambda: radiobutton_event(1), bg_color="transparent",width=200, corner_radius=5)
        ...
        self.ely_btn = ct.CTkButton(self.main_frame, text="Login with Ely.by", image=ely_img, font=("Inter", 15),  command=lambda: radiobutton_event(2), bg_color="transparent",width=200, corner_radius=5)
        self.ely_btn.place(relx=0.5, rely=0.41, anchor="center")
        off_img = ct.CTkImage(PIL.Image.open("img/welcome/offline.png"), size=(15, 15))
        self.offline_btn = ct.CTkButton(self.main_frame, text="Login Offline", image=off_img, font=("Inter", 15),  command=lambda: radiobutton_event(3), bg_color="transparent",width=200, corner_radius=5)
