...
'''This file has been edited to fit the needs of the project. The original file can be found at https://codeberg.org/JakobDev/minecraft-launcher-lib'''
"""
...
from minecraft_launcher_lib.types import MrpackInformation, MrpackInstallOptions, CallbackDict
